...
const Game1 = () => {
  return (
    <Box sx={{ marginTop: "10px", height: "190px" }}>
                ...
                <Box>
                  <Grid container sx={{ marginTop: "10px" }}>
                    <Grid item md={4} sx={{ color: '#16088c', padding: "20px", }}>
                      ...
                      <Avatar sx={{ bgcolor: "red", height: "30px", width: "30px",marginTop:"-8px" }} aria-label="recipe">
                        c
                      </Avatar>
                    </Grid>
                    <Grid item md={6} sx={{ color: '#16088c', padding: "10px" }}>
                      <Typography sx={{ fontSize: "12px", fontWeight: "800" }}>09.30 AM </Typography>
                ...
                <Box>
                  <Grid container sx={{ marginTop: "10px" }}>
                    <Grid item md={12} sx={{ color: '#16088c', padding: "10px", textAlign: 'right' }}>
                      <Typography sx={{ fontSize: "12px", fontWeight: "800" }}>08.45 AM </Typography>
                    ...
                    <Grid item md={12} sx={{ color: '#16088c', backgroundColor: 'transfrom', justifyContent: "center" }}>
                      <Grid container>
                        ...
                        <Grid item md={2} sx={{ color: "#2c0980", textAlign: "left" }}>
                          <Typography sx={{ fontSize: "20px", fontWeight: "bold" }}>91</Typography>
                        </Grid>
