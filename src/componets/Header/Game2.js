...
const Game1 = () => {
  return (
    <Box sx={{ marginTop: "10px", height: "150px" }}>
                ...
                <Box>
                  <Grid container sx={{ marginTop: "10px" }}>
                    ...
                    <Avatar sx={{ bgcolor: "red", height: "30px", width: "30px" }} aria-label="recipe">
                      ...
                      <Avatar sx={{ bgcolor: "yellow", height: "30px", width: "30px",marginTop:"-8px" }} aria-label="recipe">
                        c
                      </Avatar>
                    </Grid>
                    <Grid item md={6} sx={{ color: '#16088c', padding: "10px" }}>
                      <Typography sx={{ fontSize: "12px", fontWeight: "800" }}>07.45AM </Typography>
                ...
                <Box>
                  <Grid container sx={{ marginTop: "10px" }}>
                    <Grid item md={12} sx={{ color: '#16088c', padding: "10px", textAlign: 'right' }}>
                      <Typography sx={{ fontSize: "12px", fontWeight: "800" }}>03.40 AM </Typography>
                    ...
                    <Grid item md={12} sx={{ color: '#16088c', backgroundColor: 'transfrom', justifyContent: "center" }}>
                      <Grid container>
                        ...
                        <Grid item md={2} sx={{ color: "#2c0980", textAlign: "left" }}>
                          <Typography sx={{ fontSize: "20px", fontWeight: "bold" }}>68</Typography>
                        </Grid>
